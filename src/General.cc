...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   std::string modellocation1 = "./models/2018_bdt_retrained_raytune.txt";
  
  
   std::vector<std::string> features1{"BToKEE_fit_cos2D","BToKEE_l1_PFMvaID_retrained","BToKEE_l2_PFMvaID_retrained","BToKEE_l_xy_sig","BToKEE_lKDz","BToKEE_l1l2Dr","BToKEE_lKDr","BToKEE_p_assymetry","BToKEE_k_svip3d_sig","BToKEE_fit_pt_over_mass","BToKEE_fit_l1_pt_over_mass","BToKEE_fit_l2_pt_over_mass","BToKEE_fit_k_pt_over_mass","BToKEE_k_iso04_rel","BToKEE_l1_iso04_rel","BToKEE_l2_iso04_rel","BToKEE_ln_svprob"};
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      L1_4p5_HLT_4p0_ = L1_4p5_HLT_4p0;
      L1_5p0_HLT_4p0_ = L1_5p0_HLT_4p0;
      L1_5p5_HLT_4p0_ = L1_5p5_HLT_4p0;
      L1_5p5_HLT_6p0_ = L1_5p5_HLT_6p0;
      L1_6p0_HLT_4p0_ = L1_6p0_HLT_4p0;
      L1_6p5_HLT_4p5_ = L1_6p5_HLT_4p5;
      L1_7p0_HLT_5p0_ = L1_7p0_HLT_5p0;
      L1_7p5_HLT_5p0_ = L1_7p5_HLT_5p0;
      L1_8p0_HLT_5p0_ = L1_8p0_HLT_5p0;
      L1_8p5_HLT_5p0_ = L1_8p5_HLT_5p0;
      L1_8p5_HLT_5p5_ = L1_8p5_HLT_5p5;
      L1_9p0_HLT_6p0_ = L1_9p0_HLT_6p0;
      L1_10p5_HLT_5p0_ = L1_10p5_HLT_5p0;
      L1_10p5_HLT_6p5_ = L1_10p5_HLT_6p5;
      L1_11p0_HLT_6p5_ = L1_11p0_HLT_6p5;
      trigger_OR_ = trigger_OR;
      nTrigObj_ = nTrigObj;
      nOtherPV_ = nOtherPV;
      PV_ndof_ = PV_ndof;
      PV_x_ = PV_x;
      ...
      BToKEE_k_charge_ = BToKEE_k_charge;
      ...
      Presel_BDT_ = Presel_BDT;
      BDTSCORE_noah_ = BDTSCORE_noah;
      BDTSCORE_analysis_llkdr_ = BDTSCORE_analysis_llkdr;
      BDTSCORE_analysis_llkdr_withlow_ = BDTSCORE_analysis_llkdr_withlow;
      BDTSCORE_analysis_llkdr_withlow_withnomllcutmc_ = BDTSCORE_analysis_llkdr_withlow_withnomllcutmc;
      BToKEE_k_svipd2d_ = BToKEE_k_svipd2d;
      BToKEE_k_svipd2d_err_ = BToKEE_k_svipd2d_err;
      BToKEE_l1_dzTrg_ = BToKEE_l1_dzTrg;
      BToKEE_l2_dzTrg_ = BToKEE_l2_dzTrg;
      BToKEE_l1_dxy_ = BToKEE_l1_dxy;
      BToKEE_l2_dxy_ = BToKEE_l2_dxy;
      BToKEE_l1_dxy_err_ = BToKEE_l1_dxy_err;
      BToKEE_l2_dxy_err_ = BToKEE_l2_dxy_err;
      trig_wgt_=trig_wgt;
      ...
      std::vector<float> input1{BToKEE_fit_cos2D_,
      BToKEE_l1_PFMvaID_retrained_,
      BToKEE_l2_PFMvaID_retrained_,
      BToKEE_l_xy_sig_,
      BToKEE_lKDz_,
      BToKEE_l1l2Dr_,
      BToKEE_lKDr_,
      BToKEE_p_assymetry_,
      BToKEE_k_svip3d_/BToKEE_k_svip3d_err_,
      BToKEE_fit_pt_over_mass_,
      BToKEE_fit_l1_pt_over_mass_,
      BToKEE_fit_l2_pt_over_mass_,
      BToKEE_fit_k_pt_over_mass_,
      BToKEE_k_iso04_/BToKEE_fit_k_pt_,
      BToKEE_l1_iso04_/BToKEE_fit_l1_pt_,
      BToKEE_l2_iso04_/BToKEE_fit_l2_pt_,
      abs(log(BToKEE_svprob_))};



      BDTSCORE_2018_retrained = bdt1(input1.data());
      if (BDTSCORE_2018_retrained<0.0){
            //initVarsMC();
            goto end;
      }
      outTree_->Fill();
...
void General::Output(std::string outname, std::string outdir) {
   ...
   outTree_->Branch("L1_DoubleEG10p5_er1p2_dR_Max0p6"  ,&L1_DoubleEG10p5_er1p2_dR_Max0p6_);
   ...
   outTree_->Branch("Presel_BDT"  ,&Presel_BDT_);
   outTree_->Branch("BDTSCORE_noah"  ,&BDTSCORE_noah_);
   outTree_->Branch("BDTSCORE_analysis_llkdr"  ,&BDTSCORE_analysis_llkdr_);
   outTree_->Branch("BDTSCORE_analysis_llkdr_withlow"  ,&BDTSCORE_analysis_llkdr_withlow_);
   outTree_->Branch("BDTSCORE_analysis_llkdr_withlow_withnomllcutmc"  ,&BDTSCORE_analysis_llkdr_withlow_withnomllcutmc_);
   outTree_->Branch("BDTSCORE_2018_retrained"  ,&BDTSCORE_2018_retrained);
   outTree_->Branch("BToKEE_k_svipd2d"  ,&BToKEE_k_svipd2d_);
   outTree_->Branch("BToKEE_k_svipd2d_err"  ,&BToKEE_k_svipd2d_err_);
   outTree_->Branch("BToKEE_l1_dzTrg"  ,&BToKEE_l1_dzTrg_);
   outTree_->Branch("BToKEE_l2_dzTrg"  ,&BToKEE_l2_dzTrg_);
   outTree_->Branch("BToKEE_l1_dxy"  ,&BToKEE_l1_dxy_);
   outTree_->Branch("BToKEE_l2_dxy"  ,&BToKEE_l2_dxy_);
   outTree_->Branch("BToKEE_l1_dxy_err"  ,&BToKEE_l1_dxy_err_);
   outTree_->Branch("BToKEE_l2_dxy_err"  ,&BToKEE_l2_dxy_err_);
   outTree_->Branch("trig_wgt"  ,&trig_wgt_);
...
void General::initVars() {
    ...
    Presel_BDT_ = -1000.;
    BDTSCORE_noah_ = -1000.;
    BDTSCORE_analysis_llkdr_ = -1000.;
    BDTSCORE_analysis_llkdr_withlow_ = -1000.;
    BDTSCORE_analysis_llkdr_withlow_withnomllcutmc_ = -1000.;
    BDTSCORE_2018_retrained = -1000.;
    BToKEE_k_svipd2d_ = -1000.;
    BToKEE_k_svipd2d_err_ = -1000.;
    BToKEE_l1_dzTrg_ = -1000.;
    BToKEE_l2_dzTrg_ = -1000.;
    BToKEE_l1_dxy_ = -1000.;
    BToKEE_l2_dxy_ = -1000.;
    BToKEE_l1_dxy_err_ = -1000.;
    BToKEE_l2_dxy_err_ = -1000.;
    trig_wgt_ = -1000.;
}
