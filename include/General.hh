...
public:
   ...
   float         Presel_BDT_;
   float         BDTSCORE_noah_;
   float         BDTSCORE_analysis_llkdr_;
   float         BDTSCORE_analysis_llkdr_withlow_;
   float         BDTSCORE_analysis_llkdr_withlow_withnomllcutmc_;
   float         BDTSCORE_2018_retrained;
   float         BToKEE_k_svipd2d_;
   float         BToKEE_k_svipd2d_err_;
   float         BToKEE_l1_dzTrg_;
   float         BToKEE_l2_dzTrg_;
   float         BToKEE_l1_dxy_;
   float         BToKEE_l2_dxy_;
   float         BToKEE_l1_dxy_err_;
   float         BToKEE_l2_dxy_err_;
   float         trig_wgt_;
