...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nSV;
   UInt_t          nSkimBToKEE;
   Double_t        SkimBToKEE_fit_pt[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_eta[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_phi[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_D0_mass_LepToK_KToPi[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_D0_mass_LepToPi_KToK[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_mass[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l_xy[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l_xy_unc[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_cos2D[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_svprob[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_massErr[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_b_iso04[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_mll_fullfit[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_vtx_x[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_vtx_y[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_vtx_z[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1Idx[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2Idx[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_kIdx[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_k_pt[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_k_eta[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_k_phi[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_l1_pt[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_l1_eta[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_l1_phi[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_l2_pt[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_l2_eta[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_fit_l2_phi[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_iso04[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_iso04[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_isPF[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_isPF[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_iso04[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_isPFoverlap[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_isPFoverlap[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_LooseId[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_LooseId[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_MediumId[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_MediumId[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_TightId[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_TightId[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_ConvVeto[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_ConvVeto[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_PFMvaID_Fall17[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_PFMvaID_Fall17[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_PFMvaID_retrained[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_PFMvaID_retrained[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_iso04_dca[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_iso04_dca[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_b_iso04_dca[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_iso04_dca[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_svip3d[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_svip3d_err[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_n_isotrk_dca[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_n_isotrk_dca[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_n_isotrk_dca[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_vx[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_vy[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_vz[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1_charge[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_vx[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_vy[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_vz[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l2_charge[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_vx[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_vy[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_vz[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_dca_sig[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_dz[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_kMu_matched[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_k_charge[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l_xy_sig[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1l2Dz[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_lKDz[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_l1l2Dr[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_lKDr[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_kl_massKPi[4000];   //[nSkimBToKEE]
   Double_t        SkimBToKEE_p_assymetry[4000];   //[nSkimBToKEE]
